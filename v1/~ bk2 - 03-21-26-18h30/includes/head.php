...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="/assets/img/favicon/favicon.svg?v=<?= $assetVersion; ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="/assets/img/favicon/favicon-32x32.png?v=<?= $assetVersion; ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="/assets/img/favicon/favicon-16x16.png?v=<?= $assetVersion; ?>">
    ...
    <meta name="msapplication-config" content="/browserconfig.xml?v=<?= $assetVersion; ?>">
